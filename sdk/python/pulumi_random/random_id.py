...
class RandomId(pulumi.CustomResource):
    b64: pulumi.Output[str] = pulumi.property("b64")

    b64_std: pulumi.Output[str] = pulumi.property("b64Std")
    """
    The generated id presented in base64 without additional transformations.
    """

    b64_url: pulumi.Output[str] = pulumi.property("b64Url")
    """
    The generated id presented in base64, using the URL-friendly character set: case-sensitive letters, digits and the characters `_` and `-`.
    """

    byte_length: pulumi.Output[float] = pulumi.property("byteLength")
    """
    The number of random bytes to produce. The
    minimum value is 1, which produces eight bits of randomness.
    """

    dec: pulumi.Output[str] = pulumi.property("dec")
    """
    The generated id presented in non-padded decimal digits.
    """

    hex: pulumi.Output[str] = pulumi.property("hex")
    """
