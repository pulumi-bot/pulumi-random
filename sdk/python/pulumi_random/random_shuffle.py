...
class RandomShuffle(pulumi.CustomResource):
    inputs: pulumi.Output[List[str]] = pulumi.property("inputs")
    """
    ...
    result_count: pulumi.Output[Optional[float]] = pulumi.property("resultCount")
    """
    ...
    results: pulumi.Output[List[str]] = pulumi.property("results")
    """
    Random permutation of the list of strings given in `input`.
    """

    seed: pulumi.Output[Optional[str]] = pulumi.property("seed")
    """
