...
class RandomPet(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name, opts: Optional[pulumi.ResourceOptions] = None, keepers: Optional[pulumi.Input[Dict[str, Any]]] = None, length: Optional[pulumi.Input[float]] = None, prefix: Optional[pulumi.Input[str]] = None, separator: Optional[pulumi.Input[str]] = None, __props__=None, __name__=None, __opts__=None) -> None:
        """
    ...
    @staticmethod
    def get(resource_name: str, id: str, opts: Optional[pulumi.ResourceOptions] = None, keepers: Optional[pulumi.Input[Dict[str, Any]]] = None, length: Optional[pulumi.Input[float]] = None, prefix: Optional[pulumi.Input[str]] = None, separator: Optional[pulumi.Input[str]] = None) -> 'RandomPet':
        """
