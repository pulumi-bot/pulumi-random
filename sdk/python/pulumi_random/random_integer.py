...
class RandomInteger(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name, opts: Optional[pulumi.ResourceOptions] = None, keepers=None, max=None, min=None, seed=None, __props__=None, __name__=None, __opts__=None) -> None:
        """
